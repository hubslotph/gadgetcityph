...
const sampleProducts = [
  // Smartphones
  {
    ...
    images: [
      { url: '/images/products/placeholder_1.jpg', alt: 'iPhone 15 Pro Max - Front' }
    ],
    rating: 4.8,
    reviewCount: 1250,
    isActive: true,
  ...
  },
  {
    ...
    images: [
      { url: '/images/products/placeholder_2.jpg', alt: 'Samsung Galaxy S24 Ultra' }
    ],
    rating: 4.7,
    reviewCount: 890,
    isActive: true,
  ...
  },
  {
    ...
    images: [
      { url: '/images/products/placeholder_3.jpg', alt: 'OnePlus 12' }
    ],
    rating: 4.5,
    reviewCount: 567,
    isActive: true,
  ...
  // Laptops
  {
    ...
    images: [
      { url: '/images/products/placeholder_4.jpg', alt: 'MacBook Pro 16-inch' }
    ],
    rating: 4.9,
    reviewCount: 234,
    isActive: true,
  ...
  },
  {
    ...
    images: [
      { url: '/images/products/placeholder_5.jpg', alt: 'Dell XPS 13 Plus' }
    ],
    rating: 4.4,
    reviewCount: 456,
    isActive: true,
  ...
  // Headphones
  {
    ...
    images: [
      { url: '/images/products/placeholder_6.jpg', alt: 'Sony WH-1000XM5' }
    ],
    rating: 4.6,
    reviewCount: 1820,
    isActive: true,
  ...
  // Gaming
  {
    ...
    images: [
      { url: '/images/products/placeholder_7.jpg', alt: 'PlayStation 5' }
    ],
    rating: 4.8,
    reviewCount: 5423,
    isActive: true,
  ...
  // Smartwatches
  {
    ...
    images: [
      { url: '/images/products/placeholder_8.jpg', alt: 'Apple Watch Series 9' }
    ],
    rating: 4.6,
    reviewCount: 1234,
    isActive: true,
  ...
  // Tablets
  {
    ...
    images: [
      { url: '/images/products/placeholder_9.jpg', alt: 'iPad Pro 12.9-inch' }
    ],
    rating: 4.8,
    reviewCount: 789,
    isActive: true,
  ...
  // Accessories
  {
    ...
    images: [
      { url: '/images/products/placeholder_10.jpg', alt: 'Anker PowerCore 20000' }
    ],
    rating: 4.5,
    reviewCount: 2156,
    isActive: true,
  ...
  // Cameras
  {
    ...
    images: [
      { url: '/images/products/placeholder_11.jpg', alt: 'Sony Alpha 7 IV' }
    ],
    rating: 4.7,
    reviewCount: 432,
    isActive: true,
...
async function seedDatabase() {
  try {
    ...
    console.log('\n📸 Setting up placeholder image references...');
    ...
    console.log('\n🖼️  Image URLs in database now use local paths');
    console.log('  • Replace /images/products/placeholder_X.jpg with actual images');
    console.log('  • Use the upload endpoints to add real product images');
